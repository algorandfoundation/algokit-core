...
mod tests {
    ...
    fn test_validate_asset_creation_multiple_errors() {
        ...
        let asset_config = AssetConfigTransactionFields {
            ...
            metadata_hash: None,
            manager: Some(AccountMother::neil()),
            reserve: None,
            freeze: None,
            clawback: None,
        };
    ...
    fn test_validate_valid_asset_creation() {
        let asset_config = AssetConfigTransactionFields {
            ...
            manager: Some(AccountMother::neil()),
            reserve: Some(AccountMother::neil()),
            freeze: Some(AccountMother::neil()),
            clawback: Some(AccountMother::neil()),
        };
    ...
    fn test_validate_valid_asset_config() {
        let asset_config = AssetConfigTransactionFields {
            ...
            manager: Some(AccountMother::neil()),  // Can modify
            reserve: Some(AccountMother::neil()),  // Can modify
            freeze: Some(AccountMother::neil()),   // Can modify
            clawback: Some(AccountMother::neil()), // Can modify
        };
    ...
    fn test_validate_asset_config_multiple_immutable_field_errors() {
        let asset_config = AssetConfigTransactionFields {
            ...
            manager: Some(AccountMother::neil()),        // This is allowed
            reserve: None,
            freeze: None,
            clawback: None,
        };
