...
impl DebugSettingsProf {
    ...
    pub fn new(block_rate: Option<i32>, mutex_rate: Option<i32>) -> DebugSettingsProf {
        DebugSettingsProf {
            block_rate,
            mutex_rate,
        }
...
crate::impl_all_json_ffi!(DebugSettingsProf, debug_settings_prof, debugSettingsProf);
