...
impl DryrunState {
    ...
    pub fn new(line: i32, pc: i32, stack: Vec<models::TealValue>, scratch: Option<Vec<models::TealValue>>, error: Option<String>) -> DryrunState {
        DryrunState {
            line,
            pc,
            stack,
...
crate::impl_all_json_ffi!(DryrunState, dryrun_state, dryrunState);
