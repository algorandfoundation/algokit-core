...
impl AccountAssetsInformation200Response {
    ...
    pub fn new(round: i32, next_token: Option<String>, asset_holdings: Option<Vec<models::AccountAssetHolding>>) -> AccountAssetsInformation200Response {
...
crate::impl_all_json_ffi!(AccountAssetsInformation200Response, account_assets_information200_response, accountAssetsInformation200Response);
