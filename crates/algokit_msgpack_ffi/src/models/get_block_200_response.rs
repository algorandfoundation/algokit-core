...
pub struct GetBlock200Response {
    ...
    pub block: String,
    // Note: This field uses Algorand format: BlockHeader
    /// Optional certificate object. This is only included when the format is set to message pack.
    
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cert: Option<String>,
    // Note: This field uses Algorand format: BlockCertificate
}

impl GetBlock200Response {
    #[cfg_attr(feature = "ffi_uniffi", uniffi::constructor)]
    pub fn new(block: String, cert: Option<String>) -> GetBlock200Response {
        GetBlock200Response {
            block,
            cert,
        }
...
crate::impl_all_json_ffi!(GetBlock200Response, get_block200_response, getBlock200Response);
