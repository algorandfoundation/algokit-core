...
use crate::models::InitWalletHandleTokenResponse;

// Import request body type if needed
use crate::models::InitWalletHandleTokenRequest;

/// struct for typed errors of method [`init_wallet_handle`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
#[cfg_attr(feature = "ffi_uniffi", derive(uniffi::Error))]
pub enum InitWalletHandleError {
    DefaultResponse(),
...
pub async fn init_wallet_handle(
    ...
    let path = "/v1/wallet/init".to_string();
