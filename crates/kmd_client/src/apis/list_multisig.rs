...
use crate::models::ListMultisigResponse;

// Import request body type if needed
use crate::models::ListMultisigRequest;

/// struct for typed errors of method [`list_multisig`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
#[cfg_attr(feature = "ffi_uniffi", derive(uniffi::Error))]
pub enum ListMultisigError {
    DefaultResponse(),
...
pub async fn list_multisig(
    ...
    let path = "/v1/multisig/list".to_string();
