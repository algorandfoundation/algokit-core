...
use crate::models::{ErrorResponse, GetSyncRoundResponse};

// Import request body type if needed

/// struct for typed errors of method [`sync_round`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
#[cfg_attr(feature = "ffi_uniffi", derive(uniffi::Error))]
pub enum SyncRoundError {
...
pub async fn sync_round(http_client: &dyn HttpClient) -> Result<GetSyncRoundResponse, Error> {
