...
use crate::models::{ErrorResponse, PendingTransactionsResponse};

// Import request body type if needed

/// struct for typed errors of method [`pending_transactions_by_address`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
#[cfg_attr(feature = "ffi_uniffi", derive(uniffi::Error))]
pub enum PendingTransactionsByAddressError {
