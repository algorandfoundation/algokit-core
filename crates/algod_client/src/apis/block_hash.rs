...
use crate::models::{BlockHashResponse, ErrorResponse};

// Import request body type if needed

/// struct for typed errors of method [`block_hash`]
...
pub async fn block_hash(
    ...
    round: u64,
) -> Result<BlockHashResponse, Error> {
    let p_round = round;

    let path = format!("/v2/blocks/{round}/hash", round = p_round);
