...
/// struct for typed errors of method [`debug_settings_prof`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
#[cfg_attr(feature = "ffi_uniffi", derive(uniffi::Error))]
pub enum DebugSettingsProfError {
    DefaultResponse(),
    UnknownValue(crate::models::UnknownJsonValue),
}

/// Retrieves the current settings for blocking and mutex profiles
pub async fn debug_settings_prof(http_client: &dyn HttpClient) -> Result<DebugSettingsProf, Error> {
