...
use crate::models::{ErrorResponse, ParticipationKeysResponse};

// Import request body type if needed

/// struct for typed errors of method [`participation_keys`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
#[cfg_attr(feature = "ffi_uniffi", derive(uniffi::Error))]
pub enum ParticipationKeysError {
...
pub async fn participation_keys(
    http_client: &dyn HttpClient,
) -> Result<ParticipationKeysResponse, Error> {
