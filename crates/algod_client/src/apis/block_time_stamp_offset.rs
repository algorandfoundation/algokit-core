...
use crate::models::{ErrorResponse, GetBlockTimeStampOffsetResponse};

// Import request body type if needed

/// struct for typed errors of method [`block_time_stamp_offset`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
#[cfg_attr(feature = "ffi_uniffi", derive(uniffi::Error))]
pub enum BlockTimeStampOffsetError {
...
pub async fn block_time_stamp_offset(
    http_client: &dyn HttpClient,
) -> Result<GetBlockTimeStampOffsetResponse, Error> {
