...
use crate::models::{BlockTxidsResponse, ErrorResponse};

// Import request body type if needed

/// struct for typed errors of method [`block_tx_ids`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
#[cfg_attr(feature = "ffi_uniffi", derive(uniffi::Error))]
pub enum BlockTxIdsError {
...
pub async fn block_tx_ids(
    http_client: &dyn HttpClient,
    round: u64,
) -> Result<BlockTxidsResponse, Error> {
    let p_round = round;

    let path = format!("/v2/blocks/{round}/txids", round = p_round);
