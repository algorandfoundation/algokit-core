...
/// struct for typed errors of method [`asset_by_id`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
#[cfg_attr(feature = "ffi_uniffi", derive(uniffi::Error))]
pub enum AssetByIdError {
...
pub async fn asset_by_id(http_client: &dyn HttpClient, asset_id: u64) -> Result<Asset, Error> {
