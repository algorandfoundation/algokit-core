...
use crate::models::{BlockLogsResponse, ErrorResponse};

// Import request body type if needed

/// struct for typed errors of method [`block_logs`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
#[cfg_attr(feature = "ffi_uniffi", derive(uniffi::Error))]
pub enum BlockLogsError {
...
pub async fn block_logs(
    ...
    round: u64,
) -> Result<BlockLogsResponse, Error> {
    let p_round = round;

    let path = format!("/v2/blocks/{round}/logs", round = p_round);
