...
use crate::models::{ErrorResponse, NodeStatusResponse};

// Import request body type if needed

/// struct for typed errors of method [`status_after_block`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
#[cfg_attr(feature = "ffi_uniffi", derive(uniffi::Error))]
pub enum StatusAfterBlockError {
...
pub async fn status_after_block(
    http_client: &dyn HttpClient,
    round: u64,
) -> Result<NodeStatusResponse, Error> {
    let p_round = round;
