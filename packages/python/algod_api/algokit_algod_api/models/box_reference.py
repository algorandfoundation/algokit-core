...
class BoxReference(BaseModel):
    """
    References a box of an application.
    """ # noqa: E501
    app: StrictInt = Field(description="Application ID which this box belongs to")
    name: Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]] = Field(description="Base64 encoded box name")
    __properties: ClassVar[List[str]] = ["app", "name"]
