...
class LedgerStateDeltaForTransactionGroup(BaseModel):
    """
    Contains a ledger delta for a single transaction group
    """ # noqa: E501
    delta: Dict[str, Any] = Field(description="Ledger StateDelta object", alias="Delta")
    ids: List[StrictStr] = Field(alias="Ids")
    __properties: ClassVar[List[str]] = ["Delta", "Ids"]
