...
class GetBlockLogs200Response(BaseModel):
    """
    GetBlockLogs200Response
    """ # noqa: E501
    logs: List[AppCallLogs]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logs": [AppCallLogs.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None
        })
        return _obj
