...
class ApplicationLocalReference(BaseModel):
    """
    References an account's local state for an application.
    """ # noqa: E501
    account: StrictStr = Field(description="Address of the account with the local state.")
    app: StrictInt = Field(description="Application ID of the local state application.")
    __properties: ClassVar[List[str]] = ["account", "app"]
