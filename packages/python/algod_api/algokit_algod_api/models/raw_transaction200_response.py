...
class RawTransaction200Response(BaseModel):
    """
    RawTransaction200Response
    """ # noqa: E501
    tx_id: StrictStr = Field(description="encoding of the transaction hash.", alias="txId")
    __properties: ClassVar[List[str]] = ["txId"]
