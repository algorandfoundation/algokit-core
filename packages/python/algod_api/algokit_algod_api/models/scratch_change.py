...
class ScratchChange(BaseModel):
    """
    A write operation into a scratch slot.
    """ # noqa: E501
    slot: StrictInt = Field(description="The scratch slot written.")
    new_value: AvmValue = Field(alias="new-value")
    __properties: ClassVar[List[str]] = ["slot", "new-value"]
