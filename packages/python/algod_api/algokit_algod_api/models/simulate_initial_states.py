...
class SimulateInitialStates(BaseModel):
    """
    Initial states of resources that were accessed during simulation.
    """ # noqa: E501
    app_initial_states: Optional[List[ApplicationInitialStates]] = Field(default=None, description="The initial states of accessed application before simulation. The order of this array is arbitrary.", alias="app-initial-states")
    __properties: ClassVar[List[str]] = ["app-initial-states"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in app_initial_states (list)
        _items = []
        if self.app_initial_states:
            for _item_app_initial_states in self.app_initial_states:
                if _item_app_initial_states:
                    _items.append(_item_app_initial_states.to_dict())
            _dict['app-initial-states'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "app-initial-states": [ApplicationInitialStates.from_dict(_item) for _item in obj["app-initial-states"]] if obj.get("app-initial-states") is not None else None
        })
        return _obj
