...
class AssetHoldingReference(BaseModel):
    """
    References an asset held by an account.
    """ # noqa: E501
    account: StrictStr = Field(description="Address of the account holding the asset.")
    asset: StrictInt = Field(description="Asset ID of the holding.")
    __properties: ClassVar[List[str]] = ["account", "asset"]
