...
class AccountAssetInformation200Response(BaseModel):
    """
    AccountAssetInformation200Response
    """ # noqa: E501
    round: StrictInt = Field(description="The round for which this information is relevant.")
    asset_holding: Optional[AssetHolding] = Field(default=None, alias="asset-holding")
    created_asset: Optional[AssetParams] = Field(default=None, alias="created-asset")
    __properties: ClassVar[List[str]] = ["round", "asset-holding", "created-asset"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of created_asset
        if self.created_asset:
            _dict['created-asset'] = self.created_asset.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "created-asset": AssetParams.from_dict(obj["created-asset"]) if obj.get("created-asset") is not None else None
        })
        return _obj
