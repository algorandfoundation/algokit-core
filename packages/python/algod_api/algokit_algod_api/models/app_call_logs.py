...
class AppCallLogs(BaseModel):
    ...
    """ # noqa: E501
    logs: List[Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]]] = Field(description="An array of logs")
    application_index: StrictInt = Field(description="The application from which the logs were generated", alias="application-index")
    tx_id: StrictStr = Field(description="The transaction ID of the outer app call that lead to these logs", alias="txId")
    __properties: ClassVar[List[str]] = ["logs", "application-index", "txId"]
