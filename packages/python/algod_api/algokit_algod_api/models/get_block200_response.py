...
class GetBlock200Response(BaseModel):
    ...
    GetBlock200Response
    """ # noqa: E501
    block: Dict[str, Any] = Field(description="Block header data.")
    cert: Optional[Dict[str, Any]] = Field(default=None, description="Optional certificate object. This is only included when the format is set to message pack.")
    __properties: ClassVar[List[str]] = ["block", "cert"]
