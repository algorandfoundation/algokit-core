...
class LightBlockHeaderProof(BaseModel):
    """
    Proof of membership and position of a light block header.
    """ # noqa: E501
    index: StrictInt = Field(description="The index of the light block header in the vector commitment tree")
    ...
    proof: Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]] = Field(description="The encoded proof.")
    __properties: ClassVar[List[str]] = ["index", "treedepth", "proof"]
