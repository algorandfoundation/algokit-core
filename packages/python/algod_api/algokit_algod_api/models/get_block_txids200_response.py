...
class GetBlockTxids200Response(BaseModel):
    """
    GetBlockTxids200Response
    """ # noqa: E501
    block_txids: List[StrictStr] = Field(description="Block transaction IDs.", alias="blockTxids")
    __properties: ClassVar[List[str]] = ["blockTxids"]
