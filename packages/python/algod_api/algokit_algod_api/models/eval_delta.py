...
class EvalDelta(BaseModel):
    ...
    """ # noqa: E501
    action: StrictInt = Field(description="\\[at\\] delta action.")
    bytes: Optional[StrictStr] = Field(default=None, description="\\[bs\\] bytes value.")
    uint: Optional[StrictInt] = Field(default=None, description="\\[ui\\] uint value.")
    __properties: ClassVar[List[str]] = ["action", "bytes", "uint"]
