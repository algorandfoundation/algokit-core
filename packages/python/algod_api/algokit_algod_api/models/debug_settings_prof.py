...
class DebugSettingsProf(BaseModel):
    """
    algod mutex and blocking profiling state.
    """ # noqa: E501
    block_rate: Optional[StrictInt] = Field(default=None, description="The rate of blocking events. The profiler aims to sample an average of one blocking event per rate nanoseconds spent blocked. To turn off profiling entirely, pass rate 0.", alias="block-rate")
    mutex_rate: Optional[StrictInt] = Field(default=None, description="The rate of mutex events. On average 1/rate events are reported. To turn off profiling entirely, pass rate 0", alias="mutex-rate")
    __properties: ClassVar[List[str]] = ["block-rate", "mutex-rate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "block-rate": obj.get("block-rate"),
            "mutex-rate": obj.get("mutex-rate")
        })
        return _obj
