...
class TealCompile200Response(BaseModel):
    """
    TealCompile200Response
    """ # noqa: E501
    hash: StrictStr = Field(description="base32 SHA512_256 of program bytes (Address style)")
    result: StrictStr = Field(description="base64 encoded program bytes")
    sourcemap: Optional[Dict[str, Any]] = Field(default=None, description="JSON of the source map")
    __properties: ClassVar[List[str]] = ["hash", "result", "sourcemap"]
