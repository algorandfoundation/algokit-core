...
class TealValue(BaseModel):
    ...
    """ # noqa: E501
    type: StrictInt = Field(description="\\[tt\\] value type. Value `1` refers to **bytes**, value `2` refers to **uint**")
    bytes: StrictStr = Field(description="\\[tb\\] bytes value.")
    uint: StrictInt = Field(description="\\[ui\\] uint value.")
