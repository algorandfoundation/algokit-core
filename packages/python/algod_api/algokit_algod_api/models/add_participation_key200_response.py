...
class AddParticipationKey200Response(BaseModel):
    """
    AddParticipationKey200Response
    """ # noqa: E501
    part_id: StrictStr = Field(description="encoding of the participation ID.", alias="partId")
    __properties: ClassVar[List[str]] = ["partId"]
