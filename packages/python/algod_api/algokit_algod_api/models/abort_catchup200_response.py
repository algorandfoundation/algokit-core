...
class AbortCatchup200Response(BaseModel):
    """
    An catchpoint abort response.
    """ # noqa: E501
    catchup_message: StrictStr = Field(description="Catchup abort response string", alias="catchup-message")
    __properties: ClassVar[List[str]] = ["catchup-message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "catchup-message": obj.get("catchup-message")
        })
        return _obj
