...
class ApplicationStateSchema(BaseModel):
    ...
    """ # noqa: E501
    num_uint: StrictInt = Field(description="\\[nui\\] num of uints.", alias="num-uint")
    num_byte_slice: StrictInt = Field(description="\\[nbs\\] num of byte slices.", alias="num-byte-slice")
    __properties: ClassVar[List[str]] = ["num-uint", "num-byte-slice"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "num-uint": obj.get("num-uint"),
            "num-byte-slice": obj.get("num-byte-slice")
        })
        return _obj
