...
# Import all models from algokit_msgpack with proper error handling
try:
    from algokit_msgpack import *
    ALGOKIT_MSGPACK_AVAILABLE = True
except ImportError:
    ALGOKIT_MSGPACK_AVAILABLE = False
    # When algokit_msgpack is not available, we'll rely on the API client's error handling
