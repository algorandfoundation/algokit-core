...
def _uniffi_load_indirect():
    ...
    libname = libname.format("algokit_transact")
...
def _uniffi_check_api_checksums(lib):
    if lib.uniffi_algokit_transact_ffi_checksum_func_address_from_pub_key() != 65205:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algokit_transact_ffi_checksum_func_address_from_string() != 56499:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algokit_transact_ffi_checksum_func_assign_fee() != 10019:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algokit_transact_ffi_checksum_func_attach_signature() != 7369:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algokit_transact_ffi_checksum_func_decode_transaction() != 38127:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_algokit_transact_ffi_fn_func_address_from_pub_key.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_algokit_transact_ffi_fn_func_address_from_pub_key.restype = _UniffiRustBuffer
_UniffiLib.uniffi_algokit_transact_ffi_fn_func_address_from_string.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_algokit_transact_ffi_fn_func_address_from_string.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_algokit_transact_ffi_fn_func_attach_signature.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_algokit_transact_ffi_fn_func_attach_signature.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_algokit_transact_ffi_checksum_func_address_from_pub_key.argtypes = (
)
_UniffiLib.uniffi_algokit_transact_ffi_checksum_func_address_from_pub_key.restype = ctypes.c_uint16
_UniffiLib.uniffi_algokit_transact_ffi_checksum_func_address_from_string.argtypes = (
)
_UniffiLib.uniffi_algokit_transact_ffi_checksum_func_address_from_string.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_algokit_transact_ffi_checksum_func_attach_signature.argtypes = (
)
_UniffiLib.uniffi_algokit_transact_ffi_checksum_func_attach_signature.restype = ctypes.c_uint16
...
class Address:
    address: "str"
    pub_key: "ByteBuf"
    def __init__(self, *, address: "str", pub_key: "ByteBuf"):
        self.address = address
        self.pub_key = pub_key

    def __str__(self):
        return "Address(address={}, pub_key={})".format(self.address, self.pub_key)
...
class AssetTransferTransactionFields:
    ...
    amount: "int"
    receiver: "Address"
    asset_sender: "typing.Optional[Address]"
    close_remainder_to: "typing.Optional[Address]"
    def __init__(self, *, asset_id: "int", amount: "int", receiver: "Address", asset_sender: "typing.Optional[Address]" = _DEFAULT, close_remainder_to: "typing.Optional[Address]" = _DEFAULT):
...
class _UniffiConverterTypeAssetTransferTransactionFields(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return AssetTransferTransactionFields(
            ...
            receiver=_UniffiConverterTypeAddress.read(buf),
            asset_sender=_UniffiConverterOptionalTypeAddress.read(buf),
            close_remainder_to=_UniffiConverterOptionalTypeAddress.read(buf),
        )
    ...
    def check_lower(value):
        ...
        _UniffiConverterTypeAddress.check_lower(value.receiver)
        _UniffiConverterOptionalTypeAddress.check_lower(value.asset_sender)
        _UniffiConverterOptionalTypeAddress.check_lower(value.close_remainder_to)

    @staticmethod
    def write(value, buf):
        _UniffiConverterUInt64.write(value.asset_id, buf)
        _UniffiConverterUInt64.write(value.amount, buf)
        _UniffiConverterTypeAddress.write(value.receiver, buf)
        _UniffiConverterOptionalTypeAddress.write(value.asset_sender, buf)
        _UniffiConverterOptionalTypeAddress.write(value.close_remainder_to, buf)
...
class PaymentTransactionFields:
    ...
    amount: "int"
    close_remainder_to: "typing.Optional[Address]"
    def __init__(self, *, receiver: "Address", amount: "int", close_remainder_to: "typing.Optional[Address]" = _DEFAULT):
        self.receiver = receiver
        self.amount = amount
        if close_remainder_to is _DEFAULT:
            self.close_remainder_to = None
...
class Transaction:
    ...
    rekey_to: "typing.Optional[Address]"
    ...
    def __init__(self, *, transaction_type: "TransactionType", sender: "Address", fee: "typing.Optional[int]" = _DEFAULT, first_valid: "int", last_valid: "int", genesis_hash: "typing.Optional[ByteBuf]", genesis_id: "typing.Optional[str]", note: "typing.Optional[ByteBuf]" = _DEFAULT, rekey_to: "typing.Optional[Address]" = _DEFAULT, lease: "typing.Optional[ByteBuf]" = _DEFAULT, group: "typing.Optional[ByteBuf]" = _DEFAULT, payment: "typing.Optional[PaymentTransactionFields]" = _DEFAULT, asset_transfer: "typing.Optional[AssetTransferTransactionFields]" = _DEFAULT):
...
class _UniffiConverterTypeTransaction(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return Transaction(
            ...
            rekey_to=_UniffiConverterOptionalTypeAddress.read(buf),
    ...
    def check_lower(value):
        ...
        _UniffiConverterOptionalTypeAddress.check_lower(value.rekey_to)
    ...
    def write(value, buf):
        ...
        _UniffiConverterOptionalTypeAddress.write(value.rekey_to, buf)
...
def address_from_pub_key(pub_key: "bytes") -> "Address":
    _UniffiConverterBytes.check_lower(pub_key)
    
    return _UniffiConverterTypeAddress.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeAlgoKitTransactError,_UniffiLib.uniffi_algokit_transact_ffi_fn_func_address_from_pub_key,
...
def address_from_string(address: "str") -> "Address":
    ...
    return _UniffiConverterTypeAddress.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeAlgoKitTransactError,_UniffiLib.uniffi_algokit_transact_ffi_fn_func_address_from_string,
...
def attach_signature(encoded_tx: "bytes",signature: "bytes") -> "bytes":
    ...
    return _UniffiConverterBytes.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeAlgoKitTransactError,_UniffiLib.uniffi_algokit_transact_ffi_fn_func_attach_signature,
        _UniffiConverterBytes.lower(encoded_tx),
        _UniffiConverterBytes.lower(signature)))


def decode_transaction(bytes: "bytes") -> "Transaction":
