...
import asyncio
import platform
from .algokit_http_client_trait import HttpClient
from .algokit_http_client_trait import _UniffiConverterTypeHttpClient
from algokit_transact import Transaction
from algokit_transact import _UniffiConverterTypeTransaction
from .algokit_http_client_trait import _UniffiRustBuffer as _UniffiRustBufferHttpClient
from algokit_transact import _UniffiRustBuffer as _UniffiRustBufferTransaction
...
def _uniffi_check_api_checksums(lib):
    if lib.uniffi_algokit_utils_ffi_checksum_method_composer_add_transaction() != 56212:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_algokit_utils_ffi_checksum_method_composer_encode() != 30880:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_algokit_utils_ffi_fn_method_composer_add_transaction.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBufferTransaction,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_algokit_utils_ffi_fn_method_composer_add_transaction.restype = None
_UniffiLib.uniffi_algokit_utils_ffi_fn_method_composer_encode.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_algokit_utils_ffi_fn_method_composer_encode.restype = _UniffiRustBuffer
_UniffiLib.uniffi_algokit_utils_ffi_fn_method_composer_get_suggested_params.argtypes = (
    ctypes.c_void_p,
)
...
_UniffiLib.uniffi_algokit_utils_ffi_checksum_method_composer_add_transaction.argtypes = (
)
_UniffiLib.uniffi_algokit_utils_ffi_checksum_method_composer_add_transaction.restype = ctypes.c_uint16
_UniffiLib.uniffi_algokit_utils_ffi_checksum_method_composer_encode.argtypes = (
)
_UniffiLib.uniffi_algokit_utils_ffi_checksum_method_composer_encode.restype = ctypes.c_uint16
...
class Composer:
    ...
    def __init__(self, algod_client: "HttpClient"):
        _UniffiConverterTypeHttpClient.check_lower(algod_client)
        
        self._pointer = _uniffi_rust_call(_UniffiLib.uniffi_algokit_utils_ffi_fn_constructor_composer_new,
        _UniffiConverterTypeHttpClient.lower(algod_client))
    ...
    def add_transaction(self, transaction: "Transaction") -> None:
        ...
        _uniffi_rust_call_with_error(_UniffiConverterTypeComposerError,_UniffiLib.uniffi_algokit_utils_ffi_fn_method_composer_add_transaction,self._uniffi_clone_pointer(),
    ...
    def encode(self, ) -> "typing.List[bytes]":
        return _UniffiConverterSequenceBytes.lift(
            _uniffi_rust_call_with_error(_UniffiConverterTypeComposerError,_UniffiLib.uniffi_algokit_utils_ffi_fn_method_composer_encode,self._uniffi_clone_pointer(),)
        )




    async def get_suggested_params(self, ) -> "str":
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_algokit_utils_ffi_fn_method_composer_get_suggested_params(
...
_UniffiTempComposerError = ComposerError

class ComposerError:  # type: ignore
    class TransactionsError(_UniffiTempComposerError):
        ...
        def __repr__(self):
            return "ComposerError.TransactionsError({})".format(str(self))
    _UniffiTempComposerError.TransactionsError = TransactionsError # type: ignore

ComposerError = _UniffiTempComposerError # type: ignore
del _UniffiTempComposerError


class _UniffiConverterTypeComposerError(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        variant = buf.read_i32()
        if variant == 1:
            return ComposerError.TransactionsError(
    ...
    @staticmethod
    def check_lower(value):
        if isinstance(value, ComposerError.TransactionsError):
