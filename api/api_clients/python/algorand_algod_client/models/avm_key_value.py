...
class AvmKeyValue(BaseModel):
    """
    Represents an AVM key-value pair in an application store.
    """ # noqa: E501
    key: Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]]
    value: AvmValue
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "value": AvmValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
