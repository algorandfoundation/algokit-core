...
class AccountStateDelta(BaseModel):
    ...
    """ # noqa: E501
    address: StrictStr
    delta: List[EvalDeltaKeyValue] = Field(description="Application state delta.")
    __properties: ClassVar[List[str]] = ["address", "delta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "delta": [EvalDeltaKeyValue.from_dict(_item) for _item in obj["delta"]] if obj.get("delta") is not None else None
        })
        return _obj
