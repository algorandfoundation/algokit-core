...
@pytest.fixture
def _data_minimal():
    """Fixture providing minimal data for TransactionParametersResponse."""
    return {
        "consensus-version": '',
        "fee": 56,
        "genesis-hash": 'YQ==',
...
@pytest.fixture
def _data_full():
    """Fixture providing complete data for TransactionParametersResponse."""
    return {
        "consensus-version": '',
        "fee": 56,
        "genesis-hash": 'YQ==',
...
class TestTransactionParametersResponse:
    """TransactionParametersResponse test cases"""

    def test_TransactionParametersResponse_create_minimal(self, _data_minimal):
        """Test TransactionParametersResponse creation with minimal data."""
        instance = TransactionParametersResponse(**_data_minimal)
    ...
    def test_TransactionParametersResponse_create_full(self, _data_full):
        """Test TransactionParametersResponse creation with all fields."""
        instance = TransactionParametersResponse(**_data_full)
        assert hasattr(instance, "consensus_version")
        assert hasattr(instance, "fee")
        assert hasattr(instance, "genesis_hash")
        assert hasattr(instance, "genesis_id")
    ...
    def test_TransactionParametersResponse_to_dict(self, _data_full):
        """Test TransactionParametersResponse serialization to dict."""
        instance = TransactionParametersResponse(**_data_full)
    ...
    def test_TransactionParametersResponse_to_str(self, _data_full):
        """Test TransactionParametersResponse string representation is JSON-compatible."""
        instance = TransactionParametersResponse(**_data_full)
