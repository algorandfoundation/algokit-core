...
The generated API clients will be available in the `./api_clients` directory:

- `./api_clients/algod/typescript/` - algod TypeScript client
- `./api_clients/algod/python/` - algod Python client
